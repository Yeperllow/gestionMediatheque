...
/**
 * Implémentation de l'interface UtilisaateurService </br> Utiliser cette classe
 * pour accéder aux données de la table "UTILISATEUR"
 *
 * @author quentin
 */
@Service
public class UtilisateurServiceImpl implements UtilisateurService {
    ...
    /**
     * Champs utilisateurRepository correspondant à l'interface
     ...
     *
     * @param id l'id de l'objet de type Utilisateur qui est à supprimer de la
     * table
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir la liste de tout les utilisateurs contenus
    ...
    /**
     * Fonction permettant d'obtenir un objet de type Utilisateur dont l'id
     * correspond à celui indiqué
     *
     * @param id l'id de l'utilisateur que l'on veut obtenir
     * @return un objet de type Utilisateur si l'id correspond à un utilisateur
     * dans la table, null sinon
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir un objet de type Utilisateur dont le login
     * correspond à celui indiqué
     *
     * @param login le login de l'utilisateur que l'on veut obtenir
     * @return un objet de type Utilisateur dont le login correspond à celui
     * donné en paramètre (Peut être null)
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir une liste d'objets de type Utilisateur dont
     * les noms correspondent à celui indiqué
     *
     * @param nom le nom des utilisateurs que l'on veut obtenir
     * @return une List contenant tous les utilisateurs dont le nom correspond à
     * celui indiqué (La List peut être vide)
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir une liste d'objets de type Utilisateur dont
     * les prénoms correspondent à celui indiqué
     *
     * @param prenom le prenom des utilisateurs que l'on veut obtenir
     * @return une List contenant tous les utilisateurs dont le prenom
     * correspond à celui indiqué (La List peut être vide)
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir une liste d'objets de type Utilisateur dont
     * les noms et prénoms correspondent à ceux indiqués
     *
     * @param nom le nom des utilisateurs que l'on veut obtenir
     * @param prenom le prenom des utilisateurs que l'on veut obtenir
     * @return une List contenant tous les utilisateurs dont le nom et le prenom
     * correspondent à ceux indiqués (La List peut être vide)
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir une liste d'objets de type Utilisateur qui
     * sont actifs dans la base de données
     *
    ...
    /**
     * Fonction permettant d'obtenir une liste d'objets de type Utilisateur qui
     * sont non-actifs dans la base de données
     *
    ...
    /**
     * Fonction permettant d'obtenir une liste de tous les objets de type
     * Utilisateur de la table "UTILISATEUR", rangés par login dans l'ordre
     * croissant
     *
     * @return Une List contenant tous les utilisateurs rangés par login dans
     * l'ordre croissant
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir une liste de tous les objets de type
     * Utilisateur de la table "UTILISATEUR", rangés par nom et prénom dans
     * l'ordre croissant
     *
     * @return Une List contenant tous les utilisateurs rangés par nom et prénom
    ...
    /**
     * Fonction permettant d'obtenir une liste de tous les objets de type
     * Utilisateur de la table "UTILISATEUR", rangés par date de création dans
     * l'ordre croissant
     *
     * @return Une List contenant tous les utilisateur rangés par date de
     * création dans l'ordre croissant
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir une liste de tous les objets de type
     * Utilisateur de la table "UTILISATEUR", rangés par date de modification
     * dans l'ordre croissant
     *
     * @return Une List contenant tous les utilisateur rangés par date de
     * modification dans l'ordre croissant
     */
    @Override
     ...
     *
     * @return Une List contenant tous les utilisateur rangés par date de
     * création dans l'ordre décroissant
     */
    @Override
     ...
     *
     * @return Une List contenant tous les utilisateur rangés par date de
     * modification dans l'ordre décroissant
     */
    @Override
    ...
    /**
     * Fonction permettant d'obtenir une liste de tous les objets de type
     * Utilisateur de la table "UTILISATEUR", dont le login, le nom ou le prénom
     * contient respectivement les Strings donnés en paramètre
     *
     * @param login String que l'on veut chercher dans les logins des
